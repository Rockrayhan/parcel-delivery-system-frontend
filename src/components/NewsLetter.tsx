          ...
          >
            <label htmlFor="Email" className="flex-1">
              ...
              <input
                ...
                className="h-12 w-full rounded border-gray-100 shadow-sm bg-slate-700 px-3"
              />
            </label>

            <button
              type="submit"
              className="h-12 rounded-sm border border-indigo-600 bg-indigo-600 px-12 py-3 text-sm font-medium text-white focus:ring-3 focus:outline-hidden"
            >
              Sign Up
            </button>
          </form>
